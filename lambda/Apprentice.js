exports.handler = function (event, context) {
    try {
        ...
        if (event.session.application.applicationId !== "amzn1.ask.skill.5174cdeb-3a91-4df4-b87a-b332098af79d") {
...
function buildSpeechletResponse(title, output, repromptText, shouldEndSession) {
    ...
    return {
        ...
        card: {
            type: "Simple",
            title: "Apprentice: " + readableIntentName,
            content: output
        },
        reprompt: {
            outputSpeech: {
